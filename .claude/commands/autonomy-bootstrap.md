...
1. Confirm clare/verify-local.sh contains project-specific checks.
1. Run ./clare/verify-ci.sh and resolve failures.
1. Review humans-only boundaries with maintainers.
1. Optionally configure clare/extensions.yml for extra checks.
