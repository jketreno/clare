...
- [ ] **Confirmation tests (CLARE [A])** — tests that describe "what the code currently does" rather than "what must always be true regardless of implementation"; these should be constraint tests
